...
-   There are many online resources for getting help with code (for example, StackOverflow, ChatGPT) - you **may** use these resources for application exercises and labs but **must explicitly cite** where you have obtained code (both code you used directly and "paraphrased" code / code used as inspiration). Any reused code that is not explicitly cited will be treated as plagiarism. You **may not** use these for check-ins or exams.
